...
var mapimgtemplate = "http://maps.googleapis.com/maps/api/staticmap?zoom=14&size=320x180&maptype=roadmap&markers=color:blue%7Clabel:{{name}}%7C{{lat}},{{lon}}&sensor=false";
var mapurltemplate = "https://www.google.com/maps/preview#!q={{address_1}} {{city}} {{state}}";

$(document).ready(function(){
  var url = "http://api.meetup.com/2/events?group_id=6083632&status=upcoming&order=time&limited_events=False&desc=false&offset=0&format=json&page=20&fields=&sig_id=12399825&sig=e3db5633737115cf98c5cfb3569d2e96bb6f485a&callback=?";
